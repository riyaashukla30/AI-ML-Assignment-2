...
4. Identified features and target variable (Churn).  
5. Checked for missing values.  
6. Converted `TotalCharges` to numeric and handled missing values.  
...
10. Predicted churn for test data.  
11. Evaluated the model using Accuracy, Precision, Recall, and F1 Score.  
12. Visualized results using Confusion Matrix.  
